...
namespace SuperStore.Controllers
{
    public class OrderController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderId,Total,CustomerId,EmployeeId,DatePurchasedUtc")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderId,Total,CustomerId,EmployeeId,DatePurchasedUtc")] Order order)
        {
            if (ModelState.IsValid)
            {
